  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      {fullGraph.loading ? (
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          <StatCard
            icon={<IconModule size={26} color="#00d4ff" />}
            label="模块"
            value={moduleCount}
            color="#00d4ff"
          />
          <StatCard
            icon={<IconFunction size={26} color="#ffc145" />}
            label="函数"
            value={functionCount}
            color="#ffc145"
          />
          <StatCard
            icon={<IconAPI size={26} color="#ff6b6b" />}
            label="接口"
            value={apiCount}
            color="#ff6b6b"
          />
          <StatCard
            icon={<IconDatabase size={26} color="#b08eff" />}
            label="数据表"
            value={tableCount}
            color="#b08eff"
          />
          <StatCard
            icon={<IconEvent size={26} color="#ffcc44" />}
            label="事件"
            value={eventCount}
            color="#ffcc44"
          />
      ...
      >
        ...
        {reposLoading && <SkeletonTable rows={5} columns={4} />}
            ...
            {recentRepos.map((repo, i) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    {repo.nodeCount.toLocaleString()} 节点 ·{' '}
                    {repo.edgeCount.toLocaleString()} 边
                  </div>
                </div>
